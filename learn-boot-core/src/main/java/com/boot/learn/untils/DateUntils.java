...
public class DateUntils {
    ...
    public static void main(String[] args) {
        Date date = parseDate("2019-03-15 01:02:03", DateTimeFormatterEnum.FORMAT_DATE_TIME_STYLE_1);
        System.out.println("当前日期为: " + date);
        LocalDateTime localDateTime = parseLocalDateTime("2019-03-15 01:02:03", DateTimeFormatterEnum.FORMAT_DATE_TIME_STYLE_1);
